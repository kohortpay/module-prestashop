...
<div class="panel">
	<div class="row kohortpay-header">
		...
		<div class="col-xs-12 col-md-3 text-center">
			<a href="#" onclick="javascript:return false;" class="btn btn-primary" id="create-account-btn">{l s='Create an account' mod='kohortpay'}</a><br />
			{l s='Already have one?' mod='kohortpay'}<a href="#" onclick="javascript:return false;"> {l s='Log in' mod='kohortpay'}</a>
		</div>
	</div>
	...
	<div class="kohortpay-content">
		<div class="row">
			<div class="col-md-5">
				<h5>{l s='Benefits of using my payment module' mod='kohortpay'}</h5>
				<ul class="ul-spaced">
					<li>
			...
			<div class="col-md-2">
				<h5>{l s='Pricing' mod='kohortpay'}</h5>
				<dl class="list-unstyled">
					<dt>{l s='Payment Standard' mod='kohortpay'}</dt>
					<dd>{l s='No monthly fee' mod='kohortpay'}</dd>
					<dt>{l s='Payment Express' mod='kohortpay'}</dt>
					<dd>{l s='No monthly fee' mod='kohortpay'}</dd>
					<dt>{l s='Payment Pro' mod='kohortpay'}</dt>
					<dd>{l s='$5 per month' mod='kohortpay'}</dd>
				</dl>
				<a href="#" onclick="javascript:return false;">(Detailed pricing here)</a>
			</div>
			
			<div class="col-md-5">
				<h5>{l s='How does it work?' mod='kohortpay'}</h5>
		...
		<div class="row">
			<div class="col-md-12">
				<p class="text-muted">{l s='My Payment Module accepts more than 80 localized payment methods around the world' mod='kohortpay'}</p>
...
<div class="panel">
	<p class="text-muted">
		<i class="icon icon-info-circle"></i> {l s='In order to create a secure account with My Payment Module, please complete the fields in the settings panel below:' mod='kohortpay'}
		{l s='By clicking the "Save" button you are creating secure connection details to your store.' mod='kohortpay'}
		{l s='My Payment Module signup only begins when you client on "Activate your account" in the registration panel below.' mod='kohortpay'}
		{l s='If you already have an account you can create a new shop within your account.' mod='kohortpay'}
	</p>
	<p>
